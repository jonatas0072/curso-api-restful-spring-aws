...
public class RequestService {
    ...
    public Request findById(Long id) {
        ...
        return result.orElseThrow(() -> new NotFoundException("Não a request com este ID = " + id));
    }
    ...
    public PageModel<Request> listAllByOwnerIdOnLazy(Long usuarioId, PageRequestModel prm) {
        Pageable pageable = PageRequest.of(prm.getPage(), prm.getSize());
        Page<Request> page = requestRepository.findAllByUserId(usuarioId, pageable);

        PageModel<Request> pm =
                new PageModel<Request>(
